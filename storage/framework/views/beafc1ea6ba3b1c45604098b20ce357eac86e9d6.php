<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header"><?php echo e(t('home.FormLogin')); ?></div>
                    <div class="card-body">
                        <?php echo e(Form::open(['method' => 'POST', 'url' => route('login'), 'novalidate' => true])); ?>
                            ...
                            <div class="checkbox">
                                <label>
                                    <?php echo e(Form::checkbox('remember', old('remember'))); ?> <?php echo e(t('home.labelRememberMe')); ?>
